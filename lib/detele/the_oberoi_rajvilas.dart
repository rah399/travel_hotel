...
class TheOberoiRajvilas extends StatefulWidget {
  @override
  _TajRambaghPalaceState createState() => _TajRambaghPalaceState();
}

class _TajRambaghPalaceState extends State<TheOberoiRajvilas> {
  final List<Map<String, String>> rooms = [
    {"type": "Standard Room", "price": "\$200 per night"},
    {"type": "Deluxe Room", "price": "\$250 per night"},
    {"type": "Luxury Suite", "price": "\$500 per night"},
    {"type": "Royal Suite", "price": "\$750 per night"},
    {"type": "Presidential Suite", "price": "\$1200 per night"},
    {"type": "Garden View Suite", "price": "\$600 per night"},
    {"type": "Heritage Room", "price": "\$350 per night"},
    {"type": "Maharaja Suite", "price": "\$1500 per night"},
  ];
